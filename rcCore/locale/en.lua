local Translations = {
 error = {
  ...
  not_whitelisted = "You are not whitelisted for this server",
  server_already_open = "The server is already open",
  server_already_closed = "The server is already closed",
  no_permission = "You do not have permissions for this..",
  ...
  playerBanned = "You were permanently banned by the server for: %{value}",
  playerBannedTitle = "Player Banned",
  playerKickedTitle = "Player Kicked",
  playerDeleteExploit = "%{value} has been kicked for character deletion exploit",
  adminDeleteTitle = "Admin Deleted Character",
  adminDelete = "An admin deleted the character which you are currently using",
  playerMultiCharDropTitle = "Multiple Character Kick",
  playerMultiCharDrop = "%{value} has been kicked for character joining exploit",
 },
 success = {
